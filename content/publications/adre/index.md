...
links:
- type: journal
  url: https://journals.ametsoc.org/view/journals/clim/28/8/jcli-d-14-00426.1.xml

# Featured image
# To use, add an image named `featured.jpg/png` to your page's folder. 
image:
  caption: 'Image credit: NASA A-Train Satellite Constellation tracking aerosols and clouds'
  focal_point: ""
  preview_only: false
